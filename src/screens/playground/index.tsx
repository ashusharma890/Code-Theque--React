...
//     //     "Content-Type": "application/json",
//     //     "X-RapidAPI-Key": "5a85f903c8msh32145183d8453f5p10971bjsn4c1077f895e7",
...
//   const runCode = async () => {
//     const languageId = languageMap[currentLanguage].id;
//     const sourceCode = encode(currentCode);
//     const stdIn = encode(currentInput);

//     const token = await postSubmission(languageId, sourceCode, stdIn);

//     // const res = await getOutput(token);
//     // console.log(res);
//     // console.log(decode(res.stdout));
//     // const statusName = res.status.description;
//     // const decodedOutput = decode(res.stdout ? res.stdout : "");
//     // const decodedCompiledOutput = decode(
//     //   res.compile_output ? res.compile_output : ""
//     // );
//     // const decodedStdErr = decode(res.stderr ? res.stderr : "");

//     // let final_output = "";
//     // if (res.status_id !== 3) {
//     //   // our code has some error
//     //   if (decodedCompiledOutput === "") {
//     //     final_output = decodedStdErr;
//     //   } else {
//     //     final_output = decodedCompiledOutput;
//     //   }
//     // } else {
//     //   final_output = decodedOutput;
//     // }

//     // setCurrentOutput(statusName + "\n\n" + final_output);
